...
| 範圍 | 實作方式 |
| --- | --- |
| 搜尋與篩選 | 中英文基金名稱、供應商、基金計劃；股票、債券、混合、貨幣市場、保證及 DIS 核心分類，並可按積金局基金資訊表的中英文**基金細分類**縮窄結果。 |
| 基金資料頁 | 1 年／3 年／5 年年率化回報、FER、風險級別、推出日期與同類 5 年排名。 |
| 同類比較 | 以相同資產大類的 5 年年率化回報排序；資料摘要只描述名次與相對 FER，不作推薦。 |
| 並排比較 | 選取最多 3 隻基金，顯示指標表、Chart.js 回報曲線與 FER 長條圖；可下載包含基金 ID、回報、FER、排名、資料月份與官方來源的 CSV，亦支援 `?funds=mpfa-878,mpfa-875` 分享網址。 |
...
每月維護應保留人手核對步驟：先檢查官方資料截至月份與中英文列是否匹配，再轉換、測試、檢視差異和提交。不要把這個流程描述為自動或實時更新。
